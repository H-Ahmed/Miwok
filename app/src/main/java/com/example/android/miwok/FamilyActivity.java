...
public class FamilyActivity extends AppCompatActivity {
    ...
    /**
     * This listener gets triggered when the {@link MediaPlayer} has complated
    ...
    private void releaseMediaPlayer(){
        ...
        if (mMediaPlayer != null) {
            ...
            // setting the media player to null is an easy way to tell that the media palyer
            // os not configured to plsy an audio file at the moment.
            mMediaPlayer = null;
